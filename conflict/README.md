...
| 役割 | 作業 |
|---|---|
| **担当A：講座名** | [講座名と説明を追加する](https://github.com/soft03-git-workshop/team-02/issues/16)。先にPRをマージする。 |
| **担当B：team名** | [team名と紹介を追加する](https://github.com/soft03-git-workshop/team-02/issues/17)。その後、rebaseで解消する。 |
